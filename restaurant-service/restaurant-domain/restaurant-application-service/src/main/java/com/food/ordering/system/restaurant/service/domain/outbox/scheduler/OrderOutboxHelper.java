...
public class OrderOutboxHelper {
    ...
    public void save(OrderOutboxMessage orderOutboxMessage) {
        ...
        if (response == null) {
            ...
            throw new RestaurantDomainException("Could not save OrderOutboxMessage with outbox id: " +
                    orderOutboxMessage.getId());
        }
    ...
    private String createPayload(OrderEventPayload orderEventPayload) {
        try {
            ...
            throw new RestaurantDomainException("Could not create OrderEventPayload object for order id: " +
                    orderEventPayload.getOrderId());
        }
    }
