...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) //create a new instance before each test method call
...
public class OrderApplicationServiceTest {
    ...
    private final UUID CUSTOMER_ID = UUID.fromString("1ee342d2-225c-41e4-a0b4-fdf421734aac");
    private final UUID RESTAURANT_ID = UUID.fromString("28a18ed0-c5a7-4508-8734-bdd7a3c1db9e");
    private final UUID PRODUCT_ID = UUID.fromString("8f543ce5-acd2-47eb-a470-080c6593acf9");
    private final UUID ORDER_ID = UUID.fromString("7dd74f32-6048-41f4-8792-00e37678c161");
    private final UUID SAGA_ID = UUID.fromString("038bc630-e2ff-4ff4-a8a9-89f4242a4814");
    ...
    public void testCreateOrder() {
        ...
        assertEquals(createOrderResponse.getMessage(), "Order was created successfully");
    ...
    public void testCreateOrderWithPassiveRestaurant()  {
        Restaurant passiveRestaurant = Restaurant.Builder.builder()
                .restaurantId(new RestaurantId(RESTAURANT_ID))
                .products(List.of(new Product(new ProductId(PRODUCT_ID), "product-1",
                                new Money(new BigDecimal("50.00"))),
                        new Product(new ProductId(PRODUCT_ID), "product-2",
