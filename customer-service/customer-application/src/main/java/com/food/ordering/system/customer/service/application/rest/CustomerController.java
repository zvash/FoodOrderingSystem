...
@Slf4j
@RestController
@RequestMapping(value = "/customers", produces = "application/vnd.ap1.v1+json")
public class CustomerController {
    ...
    public ResponseEntity<CreateCustomerResponse> createCustomer(@RequestBody CreateCustomerCommand
        ...
        log.info("Creating customer with id: {}", createCustomerCommand.getCustomerId());
        CreateCustomerResponse createCustomerResponse =
                customerApplicationService.createCustomer(createCustomerCommand);
        log.info("Customer created with id: {}", createCustomerResponse.getCustomerId().toString());
