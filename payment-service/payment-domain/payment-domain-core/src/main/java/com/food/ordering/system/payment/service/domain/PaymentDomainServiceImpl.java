...
public class PaymentDomainServiceImpl implements PaymentDomainService {
    ...
    public PaymentEvent validateAndInitiatePayment(Payment payment,
        ...
        if (failureMessages.isEmpty()) {
            ...
            log.info("Payment is initiation is failed for order id: {}", payment.getOrderId().getValue());
    ...
    private void updateCreditHistory(Payment payment,
        ...
        CreditHistory creditHistory = CreditHistory.Builder.builder()
    ...
    private void validateCreditHistory(CreditEntry creditEntry,
                                       List<CreditHistory> creditHistories,
                                       List<String> failureMessages) {
        Money totalCreditHistory = getCreditHistoryAmountForTransactionType(creditHistories, TransactionType.CREDIT);

        Money totalDebitHistory = getCreditHistoryAmountForTransactionType(creditHistories, TransactionType.DEBIT);
    ...
    private Money getCreditHistoryAmountForTransactionType(List<CreditHistory> creditHistories,
                                                           TransactionType transactionType) {
